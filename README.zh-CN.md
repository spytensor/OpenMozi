...
<p align="center">
  <img src="docs/assets/readme/home.zh-CN.png" alt="Dark 模式下等待新任务的 OpenMozi 桌面应用" width="920" />
</p>
...
<p align="center">
  <img src="docs/assets/readme/run.zh-CN.png" alt="Dark 模式下 OpenMozi 完成安全合成 Dashboard 任务" width="920" />
</p>

*上图使用隔离的合成演示数据生成，不包含任何真实账号、项目、对话、密钥或机器信息。*
