...
export interface ProgressEvent {
  ...
  turnState?: string;
  /** For turn_state: optional transition detail */
  detail?: string;
  /** For project_mode_kickoff: rendered kickoff card markdown */
  card?: string;
  /** For project events: project ID */
  projectId?: string;
  /** For project_report / project_plan_updated: rendered report markdown */
  report?: string;
  /** For milestone_reached: milestone label */
  milestoneLabel?: string;
  /** For blocker_detected / risk_detected: description */
  description?: string;
  /** For team_assignment: routing reason */
  routingReason?: string;
  /** For team_assignment: model used */
  model?: string;
  /** For team_assignment: adapter used */
  adapter?: string;
