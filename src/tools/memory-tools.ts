...
export const rememberTool: ToolDefinition = {
  ...
  function: {
    name: 'remember',
    description: 'Store a fact in long-term memory for cross-session persistence. Use for user preferences, project decisions, key facts, and lessons learned. Be selective — do NOT store session-specific temporary data or trivially re-discoverable information.',
    parameters: {
      type: 'object',
      properties: {
        category: {
