      ...
      <div className="flex flex-wrap items-start gap-x-3 gap-y-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            {(showPermissionChange || request.tool || request.denied_action) && (
              <details className="group mt-1.5 text-[11px] text-ink/45">
                <summary className="inline-flex cursor-pointer list-none items-center gap-1 rounded-sm outline-none hover:text-ink/65 focus-visible:ring-2 focus-visible:ring-accent/40">
                  {t("approval.details")}
        ...
        <div className="ml-auto flex shrink-0 items-center gap-1.5">
          ...
          <button
            ...
            className="inline-flex h-8 items-center gap-1 rounded-md bg-accent px-3 text-xs font-medium text-white transition-colors hover:bg-[rgb(var(--mozi-accent-light))]"
          >
