              ...
              <div className="flex flex-col gap-1">
                {(snapshot?.roots ?? []).map((root) => (
                  ...
                  >
                    ...
                    <span className="self-start rounded px-1.5 py-0.5 text-[10.5px]" style={{ background: "var(--surface-hover)", color: "var(--text-muted)" }}>
                      {rootMeta(root, locale)}
                    </span>
                  </div>
                ))}
...
function Metric({
  ...
  return (
    <div className="rounded-md px-3 py-3" style={{ background: "var(--surface-elevated)", border: "1px solid var(--border-subtle)" }}>
      <div className="flex items-center gap-2 text-[11px]" style={{ color: "var(--text-muted)" }}>
        <Icon className="h-3.5 w-3.5" />
        <span>{label}</span>
        {ok ? <CheckCircle2 className="ml-auto h-3.5 w-3.5" style={{ color: "var(--success)" }} /> : <ShieldAlert className="ml-auto h-3.5 w-3.5" style={{ color: "var(--warning)" }} />}
