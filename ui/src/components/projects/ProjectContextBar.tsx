  ...
  return (
    <div data-testid="project-window-drag-region" className="desktop-window-drag-region shrink-0 px-5 pt-2">
      <div
        ...
        title={root.path}
        className="mx-auto flex w-full max-w-[1240px] items-center gap-2 overflow-hidden text-[11.5px] text-ink/40"
      >
        <FolderKanban className="h-3.5 w-3.5 flex-shrink-0 text-accent/70" />
